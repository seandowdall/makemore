...
N = torch.zeros((27, 27), dtype=torch.int32)  # 28 * 28 array of zeros

chars = sorted(list(set(''.join(words))))
stoi = {s: i + 1 for i, s in enumerate(chars)}  # nwo a starts at 1 'a': 1,'b': 2 ........'z':26, '.':0
stoi['.'] = 0
# first thing we need to do before visualising the data is invert the array above
itos = {i: s for s, i in stoi.items()}  # dont need to chnage this as it is just a reverse mapping
...
print(N[0,
      :])  # indexes into the zeroth row, and colon grabs all the columns  # OUTPUT; tensor([   0, 4410, 1306, 1542, 1690, 1531,  417,  669,  874,  591, 2422, 2963,
